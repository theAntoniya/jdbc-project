...
public class P02_Library_DBTest {
    ...
    */
    ...
    public void task3 () {
        ...
        // get data from DB
        String expectedBookBorrowedCount=DB_Util.getFirstRowFirstColumn();
        ...
        // get data from UI
        String actualBookBorrowedCount="513";

        //compare
        Assertions.assertEquals(expectedBookBorrowedCount,actualBookBorrowedCount);
